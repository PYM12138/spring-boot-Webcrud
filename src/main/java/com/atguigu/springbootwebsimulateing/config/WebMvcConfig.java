package com.atguigu.springbootwebsimulateing.config;

import com.atguigu.springbootwebsimulateing.component.MyI18n;
import com.atguigu.springbootwebsimulateing.component.LoginInterceptor;
...
//        有webjars-location 才能用下面的，其实这些也是设置来的
    ...
    protected void addInterceptors(InterceptorRegistry registry) {
        //这边写拦截路径,两种写法都行，(会干扰静态资源访问)
        registry.addInterceptor(new LoginInterceptor()).addPathPatterns("/**")
                .excludePathPatterns("/","/index.html","/login", "/**/*.html", "/**/*.css", "/**/*.js","/**/*.svg");
